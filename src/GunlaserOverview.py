...
#
        ...
        self.regenShutterWidget = qw.QTangoCommandSelection('Shutter', colors=self.colors, sizes=self.attr_sizes)
        self.regenOperationWidget = qw.QTangoCommandSelection('Laser', colors=self.colors, sizes=self.attr_sizes)

        self.attr_sizes.readAttributeHeight = 300

        self.regenLeePowerWidget = qw.QTangoReadAttributeSliderV(colors=self.colors, sizes=self.attr_sizes)
        ...
        self.regenLeePercentCurrentWidget = qw.QTangoReadAttributeSliderV(colors=self.colors, sizes=self.attr_sizes)
...
#
        ...
        self.mpShutterWidget = qw.QTangoCommandSelection('Shutter', colors=self.colors, sizes=self.attr_sizes)
        self.mpOperationWidget = qw.QTangoCommandSelection('Laser', colors=self.colors, sizes=self.attr_sizes)

        self.attr_sizes.readAttributeHeight = 300

        self.mpLeePowerWidget = qw.QTangoReadAttributeSliderV(colors=self.colors, sizes=self.attr_sizes)
        ...
        self.mpLeePercentCurrentWidget = qw.QTangoReadAttributeSliderV(colors=self.colors, sizes=self.attr_sizes)
...
#
        ...
        self.irEnergyWidget.setSliderLimits(0, 10)
        self.irEnergyWidget.setAttributeWarningLimits([6, 10])
...
#        layoutData.addSpacerItem(spacerItemH)
        ...
        self.layoutAttributesOsc.addSpacerItem(QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum,
        ...
        self.layoutAttributesRegen.addSpacerItem(QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum,
                                                                   QtGui.QSizePolicy.Minimum))
        ...
        self.layoutAttributesMP.addSpacerItem(QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum,
                                                                QtGui.QSizePolicy.Minimum))
        self.layoutAttributesMP.addLayout(layoutSlidersMP)
        self.layoutAttributesMP.addSpacerItem(spacerItemV)

        layoutSlidersEnergy = QtGui.QHBoxLayout()
        layoutSlidersEnergy.addWidget(self.irEnergyWidget)
