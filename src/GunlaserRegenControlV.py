...
# noinspection PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit,PyAttributeOutsideInit
...
#        self.attr_sizes.fontType = 'Trebuchet MS'
        ...
        self.layoutAttributes4.setSpacing(self.attr_sizes.barHeight/2)
        ...
        self.leeLaserPowerWidget = qw.QTangoReadAttributeSliderV(colors = self.colors, sizes = self.attr_sizes)
        ...
        self.kmpcVoltageWidget = qw.QTangoReadAttributeSliderCompact(colors = self.colors, sizes = self.attr_sizes)
        ...
        self.ionpumpPressureWidget = qw.QTangoReadAttributeSliderCompact(colors = self.colors, sizes = self.attr_sizes)
        ...
        self.temperatureWidget = qw.QTangoReadAttributeSliderCompact(colors = self.colors, sizes = self.attr_sizes)
