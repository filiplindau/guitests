...
# Halcyon attributes
#
        self.modelockedWidget = qw.QTangoReadAttributeBoolean(colors = self.colors, sizes = self.attrSizes)
        self.modelockedWidget.setAttributeName('Modelocked')

        self.jitterWidget = qw.QTangoReadAttributeSliderV(colors = self.colors, sizes = self.attrSizes)
...
#        layoutData.addSpacerItem(spacerItemH)
        ...
        self.layoutAttributes.addLayout(layoutSlidersFinesse)
