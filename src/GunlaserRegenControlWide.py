...
#        self.attrSizes.fontType = 'Trebuchet MS'
        ...
        self.kmpcVoltageWidget = qw.QTangoReadAttributeSlider4(colors = self.colors, sizes = self.attrSizes)
...
#        self.crystalImageWidget.fixedSize(True)
        ...
        self.layoutAttributes2.addSpacerItem(spacerItemBar)
        self.layoutAttributes2.addWidget(self.kmpcOperationWidget)
        self.layoutAttributes2.addWidget(self.kmpcVoltageWidget)
        self.layoutAttributes2.addSpacerItem(spacerItemV)

        self.layoutAttributes3.addWidget(self.crystalImageName)
        self.layoutAttributes3.addWidget(self.crystalImageOperationWidget)
