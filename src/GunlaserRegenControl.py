...
#             device.terminate()
    ...
    def setupLayout(self):
        ...
        self.frameSizes.readAttributeWidth = 350
...
#        self.frameSizes.fontType = 'Trebuchet MS'
        ...
        self.attrSizes.readAttributeWidth = 350
...
#        self.attrSizes.fontType = 'Trebuchet MS'
        ...
        self.leeLaserCurrentWidget = qw.QTangoReadAttributeSlider2(colors = self.colors, sizes = self.attrSizes)
        ...
        self.leeLaserPercentCurrentWidget = qw.QTangoWriteAttributeSlider(colors = self.colors, sizes = self.attrSizes)
        ...
        self.kmpcVoltageWidget = qw.QTangoReadAttributeSlider2(colors = self.colors, sizes = self.attrSizes)
        ...
        self.ionpumpPressureWidget = qw.QTangoReadAttributeSlider2(colors = self.colors, sizes = self.attrSizes)
        ...
        self.temperatureWidget = qw.QTangoReadAttributeSlider2(colors = self.colors, sizes = self.attrSizes)
...
#        layoutData.addWidget(self.crystalImageWidget)
        ...
        self.layoutAttributes.addWidget(self.crystalImageName)
        ...
        self.layoutAttributes.addSpacerItem(spacerItemV)
        self.layoutAttributes.addWidget(self.ionpumpPressureWidget)
        self.layoutAttributes.addWidget(self.temperatureWidget)

        self.layoutAttributes.addSpacerItem(spacerItemV)
        self.layoutAttributes.addWidget(self.kmpcOperationWidget)
        self.layoutAttributes.addWidget(self.kmpcVoltageWidget)

        self.layoutAttributes.addSpacerItem(spacerItemV)
        self.layoutAttributes.addWidget(self.crystalImageOperationWidget)
        self.layoutAttributes.addWidget(self.crystalImageWidget)
