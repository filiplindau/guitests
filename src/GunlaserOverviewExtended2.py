...
class TangoDeviceClient(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.devices['irFrog'] = pt.DeviceProxy('gunlaser/devices/ir_frog_ss')
        ...
        self.attributes["pulsewidth"] = AttributeClass("pulsewidth", self.devices["irFrog"], 1.0)
        self.attributes["pulsewidth"].attrSignal.connect(self.readPulsewidth)
        self.attributes["efield"] = AttributeClass("e_field", self.devices["irFrog"], 1.0)
        self.attributes["efield"].attrSignal.connect(self.readEfield)
        self.attributes["phase"] = AttributeClass("phase", self.devices["irFrog"], 1.0)
        self.attributes["phase"].attrSignal.connect(self.readPhase)
        self.attributes['frogtime'] = AttributeClass('timevector', self.devices['irFrog'], None)
        self.attributes["frogtime"].attrSignal.connect(self.readTimevector)
    ...
    def readOscillatorPower(self, data):
        ...
        self.trend_widget.addPoint(data, 0)
    ...
    def readWavelengths(self, data):
        try:
            ...
            pass
        self.spectrumVector = data.value

    def readSpectrum(self, data):
        if self.spectrumVector is None:
            print 'No spectrum vector'
        else:
            self.oscSpectrumPlot.setSpectrum(xData=self.spectrumVector, yData=data)
    ...
    def readPulsewidth(self, data):
        data.value = data.value * 1e15
        self.pulsewidthWidget.setAttributeValue(data)

    def readEfield(self, data):
        data.value = data.value**2
        if self.timeVector is None:
            print 'No time vector'
        else:
            self.efieldPlot.setSpectrum(xData=self.timeVector, yData=data, index=0)
            self.efieldPlot.update()

    def readPhase(self, data):
        if self.timeVector is None:
            print 'No time vector'
        else:
            self.efieldPlot.setSpectrum(xData=self.timeVector, yData=data, index=1)
            self.efieldPlot.update()
    ...
    def readTimevector(self, data):
        try:
            ...
            pass
        self.timeVector = data.value * 1e15
    ...
    def setupLayout(self):
        ...
        plot_sizes = qw.QTangoSizes()
        plot_sizes.barHeight = 30
        plot_sizes.barWidth = 20
        plot_sizes.readAttributeWidth = 200
        plot_sizes.readAttributeHeight = 250
        plot_sizes.writeAttributeWidth = 299
        plot_sizes.fontStretch = 80
        plot_sizes.fontType = 'Arial'
        ...
        self.finessePowerWidget.setAttributeName('Finesse Pwr', 'W')
        ...
        self.oscSpectrumPlot = qw.QTangoReadAttributeSpectrum(colors=self.colors, sizes=plot_sizes)
        ...
        self.pataraEnergyWidget.setAttributeName('Patara Ergy', 'mJ')
        ...
        self.regenTempWidget.setAttributeName('Regen xtal', u"\xb0C")
        ...
        self.mpTempWidget.setAttributeName('MP xtal', u'\xb0C')
        ...
        # FROG widgets
        #
        self.pulsewidthWidget = qw.QTangoReadAttributeSliderV(colors=self.colors, sizes=self.attr_sizes)
        self.pulsewidthWidget.setAttributeName('IR pulse', 'fs')
        self.pulsewidthWidget.setSliderLimits(0, 150)
        self.pulsewidthWidget.setAttributeWarningLimits([30, 120])

        self.efieldPlot = qw.QTangoReadAttributeSpectrum(colors=self.colors, sizes=plot_sizes)
        self.efieldPlot.setAttributeName('FROG reconstruction')
        self.efieldPlot.spectrum.setCurveName(0, "Intensity")
        col = "{0}99".format(self.colors.tertiaryColor1)
        self.efieldPlot.spectrum.addPlot(col, "Phase", "left")
        self.efieldPlot.setXRange(-500, 500)
        # self.efieldPlot.setMinimumWidth(600)
        self.efieldPlot.setMaximumWidth(600)
        self.efieldPlot.setMinimumHeight(200)
        self.efieldPlot.setMaximumHeight(200)
        self.efieldPlot.setSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        self.efieldPlot.spectrum.showLegend(True)
        ...
        # Trends
        #
        self.trend_widget = qw.QTangoReadAttributeTrend(name='P osc / mW', colors=self.colors,
                                                        sizes=plot_sizes)
        self.trend_widget.setSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.trend_widget.valueTrend.setSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        self.trend_widget.setMaximumHeight(200)
        self.trend_widget.setMaximumWidth(1500)
        self.trend_widget.setAttributeName('Output trend', '')
        self.trend_widget.setDuration(10800.0)
        self.trend_widget.showLegend(True)
        self.trend_widget.addCurve(name="W IR x10 / mJ")
        self.trend_widget.addCurve(name="W UV / uJ")
        self.trend_widget.curve_focus = 10
        self.trend_widget.curveNameLabel.setText("")
        ...
        osc_lay = QtGui.QVBoxLayout()
        osc_lay.addSpacerItem(QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum,
                                                                    QtGui.QSizePolicy.Expanding))
        osc_lay2 = QtGui.QHBoxLayout()
        osc_lay2.addWidget(self.oscillatorPowerWidget)
        osc_lay2.addWidget(self.peakWidthWidget)
        osc_lay2.addSpacerItem(QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Expanding,
                                                                    QtGui.QSizePolicy.Minimum))
        # oscillator_widget.addWidget(self.piezoVoltageWidget)
        osc_lay2.addWidget(self.errorFrequencyWidget)
        osc_lay2.addWidget(self.jitterWidget)
        osc_lay.addLayout(osc_lay2)
        oscillator_widget.addLayout(osc_lay)
        oscillator_widget.setMinimumHeight(350)
        oscillator_widget.setMaximumHeight(350)
        ...
        amp_sliders.addWidget(self.pulsewidthWidget)
        amp_sliders.addSpacerItem(QtGui.QSpacerItem(5, 5, QtGui.QSizePolicy.Expanding,
                                                     QtGui.QSizePolicy.Minimum))
        amp_sliders.addWidget(self.uvEnergyWidget)
        amp_sliders.addWidget(self.uvPercentWidget)
        amp_plots_lay = QtGui.QHBoxLayout()
        amp_plots_lay.addWidget(self.efieldPlot)
        amp_plots_lay.addWidget(self.trend_widget)
        amp_v_layout = QtGui.QVBoxLayout()
        amp_v_layout.addLayout(amp_plots_lay)
        amp_v_layout.addSpacerItem(QtGui.QSpacerItem(5, 5, QtGui.QSizePolicy.Minimum,
                                                     QtGui.QSizePolicy.Expanding))
        ...
        cryo_sliders.addSpacerItem(QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Expanding,
                                                      QtGui.QSizePolicy.Minimum))
        ...
        cryos_widget.setMinimumHeight(350)
        cryos_widget.setMaximumHeight(350)
        ...
        layoutData_1.addSpacerItem(QtGui.QSpacerItem(20, 20, QtGui.QSizePolicy.Expanding,
                                                                    QtGui.QSizePolicy.Minimum))
        # layoutData_1.addWidget(uv_widget)
