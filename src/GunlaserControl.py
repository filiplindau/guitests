...
#             device.terminate()
    ...
    def setupLayout(self):
        ...
        self.frameSizes.readAttributeWidth = 280
...
#        self.frameSizes.fontType = 'Trebuchet MS'
        ...
        self.attrSizes.readAttributeWidth = 280
...
#        self.attrSizes.fontType = 'Trebuchet MS'
        ...
        self.finesse_name = qw.QTangoDeviceNameStatus(colors = self.colors, sizes = self.frameSizes)
        self.finesse_name.setAttributeName('Finesse')

        self.finesse_shutter_widget = qw.QTangoCommandSelection('Shutter', colors = self.colors, sizes = self.attrSizes)
        ...
        self.finesse_operation_widget = qw.QTangoCommandSelection('Operation', colors = self.colors, sizes = self.attrSizes)
        ...
        self.finesse_power_widget = qw.QTangoReadAttributeDouble(colors = self.colors, sizes = self.attrSizes)
        self.finesse_power_widget.setAttributeName('Finesse power', 'W')

        self.finesse_temp_widget = qw.QTangoReadAttributeDouble(colors = self.colors, sizes = self.attrSizes)
        self.finesse_temp_widget.setAttributeName('Finesse temp', 'degC')

        self.oscillator_power_widget = qw.QTangoReadAttributeDouble(colors = self.colors, sizes = self.attrSizes)
        self.oscillator_power_widget.setAttributeName('Oscillator power', 'W')
        self.oscillator_power_widget.setPrefix('m')
        self.oscillator_peak_width_widget = qw.QTangoReadAttributeDouble(colors = self.colors, sizes = self.attrSizes)
        self.oscillator_peak_width_widget.setAttributeName('Width FWHM', 'nm')
        self.oscillator_spectrum_plot = qw.QTangoReadAttributeSpectrum(colors = self.colors, sizes = self.attrSizes)
        ...
        self.error_frequency_widget = qw.QTangoReadAttributeDouble(colors = self.colors, sizes = self.attrSizes)
        self.error_frequency_widget.setAttributeName('Error frequency', 'Hz')
        self.error_trace_widget = qw.QTangoReadAttributeSpectrum(colors = self.colors, sizes = self.attrSizes)
...
#        self.error_trace_widget.fixedSize(fixed=True)
        ...
        self.regen_operation_widget = qw.QTangoCommandSelection('Operation', colors = self.colors, sizes = self.attrSizes)
        ...
        self.regen_shutter_widget = qw.QTangoCommandSelection('Shutter', colors = self.colors, sizes = self.attrSizes)
        ...
        self.regen_current_widget = qw.QTangoWriteAttributeDouble(colors = self.colors, sizes = self.attrSizes)
        ...
        self.regen_temp_widget = qw.QTangoReadAttributeDouble(colors = self.colors, sizes = self.attrSizes)
        self.regen_temp_widget.setAttributeName('Regen cryo temp', 'degC')

        self.mp_lee_name = qw.QTangoDeviceNameStatus(colors = self.colors, sizes = self.frameSizes)
        self.mp_lee_name.setAttributeName('MP LeeLaser')
        self.mp_operation_widget = qw.QTangoCommandSelection('Operation', colors = self.colors, sizes = self.attrSizes)
        ...
        self.mp_shutter_widget = qw.QTangoCommandSelection('Shutter', colors = self.colors, sizes = self.attrSizes)
        ...
        self.mp_current_widget = qw.QTangoWriteAttributeDouble(colors = self.colors, sizes = self.attrSizes)
        ...
        self.mp_temp_widget = qw.QTangoReadAttributeDouble(colors = self.colors, sizes = self.attrSizes)
...
#        layoutData.addSpacerItem(spacerItemH)
        ...
        self.layoutAttributes.addWidget(self.finesse_name)
        self.layoutAttributes.addWidget(self.finesse_operation_widget)
        self.layoutAttributes.addWidget(self.finesse_shutter_widget)
        self.layoutAttributes.addSpacerItem(spacerItemBar)
        self.layoutAttributes.addWidget(self.regen_lee_name)
        self.layoutAttributes.addWidget(self.regen_operation_widget)
        self.layoutAttributes.addWidget(self.regen_shutter_widget)
        self.layoutAttributes.addSpacerItem(spacerItemBar)
        self.layoutAttributes.addWidget(self.mp_lee_name)
        self.layoutAttributes.addWidget(self.mp_operation_widget)
        self.layoutAttributes.addWidget(self.mp_shutter_widget)
